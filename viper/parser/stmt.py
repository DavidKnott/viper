...
class Stmt(object):
    ...
    def call(self):
        ...
        if isinstance(self.stmt.func, ast.Name) and self.stmt.func.id in stmt_dispatch_table:
            ...
            return external_contract_call_stmt(self.stmt, self.context, contract_name, contract_address, False)
            ...
            return external_contract_call_stmt(self.stmt, self.context, contract_name, contract_address, var.trusted)
